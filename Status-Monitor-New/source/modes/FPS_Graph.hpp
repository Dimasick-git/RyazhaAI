    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        auto* Status = new tsl::elm::CustomDrawer([this](tsl::gfx::Renderer *renderer, u16 x, u16 y, u16 w, u16 h) {
            ...
            if (settings.showInfo) {
                ...
                // Line 0: CPU
                renderer->drawString("ЦПУ", false, info_x, startY, fontSize, settings.catColor);
                renderer->drawString(CPU_Load_c, false, value_x, startY, fontSize, settings.textColor);
                
                // Line 1: GPU
                renderer->drawString("ГПУ", false, info_x, startY + lineHeight+SPACING, fontSize, settings.catColor);
                renderer->drawString(GPU_Load_c, false, value_x, startY + lineHeight+SPACING, fontSize, settings.textColor);
                
                // Line 2: RAM
                renderer->drawString("ОЗУ", false, info_x, startY + lineHeight * 2+2*SPACING, fontSize, settings.catColor);
                ...
                renderer->drawString("СИС", false, info_x, startY + lineHeight * 3+3*SPACING, fontSize, settings.catColor);
                ...
                renderer->drawString("ПЛАТА", false, info_x, startY + lineHeight * 4+4*SPACING, fontSize, settings.catColor);
                ...
                renderer->drawString("Корпус", false, info_x, startY + lineHeight * 5+5*SPACING, fontSize, settings.catColor);
