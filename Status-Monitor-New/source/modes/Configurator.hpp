...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        tsl::elm::OverlayFrame* rootFrame = new tsl::elm::OverlayFrame("Ryazha-Status-Monitor", "Альфа");
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto* list = new tsl::elm::List();
        list->addItem(new tsl::elm::CategoryHeader("Формат DTC"));
        ...
        tsl::elm::OverlayFrame* rootFrame = new tsl::elm::OverlayFrame("Ryazha-Status-Monitor", "Формат DTC");
        rootFrame->setContent(list);
        return rootFrame;
    }
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto* list = new tsl::elm::List();
        list->addItem(new tsl::elm::CategoryHeader("Переключатели"));
        
        if (isFPSGraphMode) {
            // FPS Graph: show_info and disable_screenshots
            auto* showInfo = new tsl::elm::ToggleListItem("Инфо", getCurrentShowInfo());
            ...
            auto* disableScreenshots = new tsl::elm::ToggleListItem("Запрет скринш.", getCurrentDisableScreenshots("fps-graph"));
            ...
            auto* realFreqs = new tsl::elm::ToggleListItem("Реал. частоты", getCurrentShowRealFreqs());
            ...
            auto* showDeltas = new tsl::elm::ToggleListItem("Дельты", getCurrentShowDeltas());
            ...
            auto* targetFreqs = new tsl::elm::ToggleListItem("Цел. частоты", getCurrentShowTargetFreqs());
            ...
            auto* showFPS = new tsl::elm::ToggleListItem("Частота", getCurrentShowFPS());
            ...
            auto* showRES = new tsl::elm::ToggleListItem("Разреш.", getCurrentShowRES());
            ...
            auto* showRDSD = new tsl::elm::ToggleListItem("Скор. чтения", getCurrentShowRDSD());
            ...
            auto* disableScreenshots = new tsl::elm::ToggleListItem("Запрет скринш.", getCurrentDisableScreenshots("full"));
            disableScreenshots->setStateChangedListener([this](bool state) {
            ...
            auto* realFreqs = new tsl::elm::ToggleListItem("Реал. частоты", getCurrentRealFreqs());
            ...
            auto* realVolts = new tsl::elm::ToggleListItem("Реал. вольты", getCurrentRealVolts());
            ...
            auto* showFullCPU = new tsl::elm::ToggleListItem("CPU полностью", getCurrentShowFullCPU());
            ...
            auto* showFullRes = new tsl::elm::ToggleListItem("Полное разр.", getCurrentShowFullRes());
            ...
            auto* socVoltage = new tsl::elm::ToggleListItem("Напр. SOC", getCurrentShowSOCVoltage());
            ...
            if (isMiniMode) {
                auto* ramLoadCPUGPU = new tsl::elm::ToggleListItem("RAM нагруз. CPU/GPU", getCurrentShowRAMLoadCPUGPU());
            ...
            if (isMiniMode || isMicroMode) {
                auto* invertBatteryDisplay = new tsl::elm::ToggleListItem("Инверт. батарею", getCurrentInvertBatteryDisplay());
            ...
            auto* dtcSymbol = new tsl::elm::ToggleListItem("Символ DTC", getCurrentUseDTCSymbol());
            ...
            auto* disableScreenshots = new tsl::elm::ToggleListItem("Запрет скринш.", getCurrentDisableScreenshots(section));
            ...
            auto* sleepExit = new tsl::elm::ToggleListItem("Выход при сне", getCurrentSleepExit(section));
            ...
            auto* disableScreenshots = new tsl::elm::ToggleListItem("Запрет скринш.", getCurrentDisableScreenshots("game_resolutions"));
            disableScreenshots->setStateChangedListener([this](bool state) {
            ...
            auto* integerCounter = new tsl::elm::ToggleListItem("Целый счётчик", getCurrentUseIntegerCounter("fps-counter"));
        ...
        tsl::elm::OverlayFrame* rootFrame = new tsl::elm::OverlayFrame("Ryazha-Status-Monitor", "Настройки");
        rootFrame->setContent(list);
        return rootFrame;
    }
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto* list = new tsl::elm::List();
        list->addItem(new tsl::elm::CategoryHeader("Частота обновл."));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto* list = new tsl::elm::List();
        list->addItem(new tsl::elm::CategoryHeader("Отступ рамки"));
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        tsl::elm::OverlayFrame* rootFrame = new tsl::elm::OverlayFrame("Ryazha-Status-Monitor", "Размеры шрифта");
        rootFrame->setContent(list);
        return rootFrame;
    }
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto* list = new tsl::elm::List();
        list->addItem(new tsl::elm::CategoryHeader("Размеры шрифта"));
        ...
        auto* handheldItem = new tsl::elm::ListItem("Шрифт (портатив)");
        ...
        auto* dockedItem = new tsl::elm::ListItem("Шрифт (док)");
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        // A set of basic colors. Many keys are shared between overlays.
        static const std::vector<std::pair<std::string, std::string>> colorOptions = {
            // Grays & Basics
            {"Чёрный", "#000F"},
            {"Тёмно-серый", "#333F"},
            {"Серый", "#444F"},
            ...
            // Purples
            {"Тёмно-фиолетовый", "#808F"},
            {"Фиолетовый", "#80FF"},
            {"Светло-фиолетовый", "#C8FF"},
            {"Сиреневый", "#A0FF"},
        ...
        tsl::elm::OverlayFrame* rootFrame = new tsl::elm::OverlayFrame("Ryazha-Status-Monitor", "Цвета");
        rootFrame->setContent(list);
        return rootFrame;
    }
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto* list = new tsl::elm::List();
        list->addItem(new tsl::elm::CategoryHeader("Цвета"));
        ...
        auto getColorName = [](const std::string& hexColor) -> std::string {
            ...
            static const std::map<std::string, std::string> colorNames = {
                ...
                // Purples
                {"#808", "Тёмно-фиолетовый"},
                {"#80F", "Фиолетовый"},
                {"#C8F", "Светло-фиолетовый"},
                {"#A0F", "Сиреневый"},
        ...
        if (!isFullMode) {
            ...
            auto* bgColor = new tsl::elm::ListItem("Цвет фона");
            ...
            bgColor->setClickListener([this, bgDefault](uint64_t keys) {
                if (keys & KEY_A) {
                    tsl::changeTo<ColorSelector>(modeName, "Цвет фона", "background_color", bgDefault);
                    return true;
                }
                return false;
            });
            ...
            auto* bgAlpha = new tsl::elm::ListItem("Прозрачность фона");
            bgAlpha->setValue(getAlphaPercentage(bgCurrentColor));
            bgAlpha->setClickListener([this](uint64_t keys) {
                if (keys & KEY_A) {
                    tsl::changeTo<AlphaSelector>(modeName, "background_color", "Прозрачность фона");
                    return true;
                }
                return false;
            });
            ...
            if (isMiniMode || isFPSCounterMode || isFPSGraphMode || isGameResolutionsMode) {
                ...
                auto* focusBgColor = new tsl::elm::ListItem("Цвет фокуса");
                ...
                focusBgColor->setClickListener([this](uint64_t keys) {
                    if (keys & KEY_A) {
                        tsl::changeTo<ColorSelector>(modeName, "Цвет фокуса", "focus_background_color", "#000F");
                        return true;
                    }
                    return false;
                });
                ...
                // Focus Alpha (new)
                auto* focusAlpha = new tsl::elm::ListItem("Альфа фокуса");
                focusAlpha->setValue(getAlphaPercentage(focusCurrentColor));
                focusAlpha->setClickListener([this](uint64_t keys) {
                    if (keys & KEY_A) {
                        tsl::changeTo<AlphaSelector>(modeName, "focus_background_color", "Альфа фокуса");
                        return true;
                    }
                    return false;
                });
        ...
        auto* textColor = new tsl::elm::ListItem("Цвет текста");
        ...
        textColor->setClickListener([this](uint64_t keys) {
            if (keys & KEY_A) {
                tsl::changeTo<ColorSelector>(modeName, "Цвет текста", "text_color", "#FFFF");
                return true;
            }
            return false;
        });
        ...
        if (isFPSGraphMode) {
            ...
            auto* catColor = new tsl::elm::ListItem("Цвет категории");
            catColor->setValue(getColorName(getCurrentColor("cat_color", "#0F0F")));
            catColor->setClickListener([this](uint64_t keys) {
                if (keys & KEY_A) {
                    tsl::changeTo<ColorSelector>(modeName, "Цвет категории", "cat_color", "#0F0F");
                    return true;
                }
                return false;
            });
            ...
            static const std::vector<ColorSetting> fpsGraphColors = {
                {"Счётчик FPS", "fps_counter_color", "#888C", true},      // background type
                {"Граница", "border_color", "#2DFF", false},               // text type
                {"Пунктирная линия", "dashed_line_color", "#8888", true},      // background type
                {"Текст макс. FPS", "max_fps_text_color", "#FFFF", false},   // text type
                {"Текст мин. FPS", "min_fps_text_color", "#FFFF", false},   // text type
                {"Основная линия", "main_line_color", "#FFFF", false},         // text type
                {"Скруглённая линия", "rounded_line_color", "#F0FF", false},   // text type
                {"Идеальная линия", "perfect_line_color", "#0C0F", false}    // text type
            };
            
            for (const auto& color : fpsGraphColors) {
                auto* colorItem = new tsl::elm::ListItem(color.name + " Цвет");
                ...
                if (color.isBackgroundType) {
                    auto* alphaItem = new tsl::elm::ListItem(color.name + " Альфа");
                    alphaItem->setValue(getAlphaPercentage(currentVal));
                    alphaItem->setClickListener([this, color](uint64_t keys) {
                        if (keys & KEY_A) {
                            tsl::changeTo<AlphaSelector>(modeName, color.key, color.name + " Прозрачность");
                            return true;
                        }
                        return false;
                    });
            ...
            auto* catColor1 = new tsl::elm::ListItem("Цвет категории 1");
            ...
            catColor1->setClickListener([this](uint64_t keys) {
                if (keys & KEY_A) {
                    tsl::changeTo<ColorSelector>(modeName, "Цвет категории 1", "cat_color_1", "#8FFF");
                    return true;
                }
                return false;
            });
            ...
            auto* catColor2 = new tsl::elm::ListItem("Цвет категории 2");
            // Display color name for category colors
            catColor2->setValue(getColorName(getCurrentColor("cat_color_2", "#2DFF")));
            catColor2->setClickListener([this](uint64_t keys) {
                if (keys & KEY_A) {
                    tsl::changeTo<ColorSelector>(modeName, "Цвет категории 2", "cat_color_2", "#2DFF");
                    return true;
                }
                return false;
            });
            ...
            auto* sepColor = new tsl::elm::ListItem("Цвет разделителя");
            ...
            sepColor->setClickListener([this](uint64_t keys) {
                if (keys & KEY_A) {
                    tsl::changeTo<ColorSelector>(modeName, "Цвет разделителя", "separator_color", "#888F");
                    return true;
                }
                return false;
            });
            ...
            catColor->setClickListener([this](uint64_t keys) {
                if (keys & KEY_A) {
                    tsl::changeTo<ColorSelector>(modeName, "Цвет категории", "cat_color", "#2DFF");
                    return true;
                }
                return false;
            });
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        auto* list = new tsl::elm::List();
        list->addItem(new tsl::elm::CategoryHeader("Элементы " + ult::DIVIDER_SYMBOL + " \uE0E3 Вниз " + ult::DIVIDER_SYMBOL + " \uE0E2 Вверх"));
        ...
        if (showValue.empty()) {
            showValue = isMiniMode ? "DTC+БАТ+ЦПУ+ГПУ+ОЗУ+ТМП+ЧАСТ+РЕЗ" : "ЧАСТ+ЦПУ+ГПУ+ОЗУ+СИС+БАТ+DTC";
        }
        // Don't convertToUpper for Russian elements
        ...
        static constexpr std::string_view miniElements[] = {
            "DTC","БАТ","ЦПУ","ГПУ","ОЗУ","ТМП","ЧАСТ","РЕЗ","READ","SOC"
        };
        
        static constexpr std::string_view microElements[] = {
            "ЧАСТ","ЦПУ","ГПУ","ОЗУ","ЧТЕНИЕ","СИС","ТМП","РЕЗ","БАТ","DTC"
        };
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        if (isMiniMode || isMicroMode) {
            auto* showSettings = new tsl::elm::ListItem("Элементы");
        ...
        auto* toggles = new tsl::elm::ListItem("Переключатели");
        ...
        //if (!isFullMode) {
        auto* colors = new tsl::elm::ListItem("Цвета");
        ...
        if (isMiniMode || isMicroMode || isFPSCounterMode) {
            auto* fontSizes = new tsl::elm::ListItem("Размеры шрифта");
        ...
        auto* refreshRate = new tsl::elm::ListItem("Частота обновл.");
        ...
        if (isMiniMode || isMicroMode) {
            auto* dtcFormat = new tsl::elm::ListItem("Формат DTC");
        ...
        if (isMiniMode || isGameResolutionsMode || isFPSCounterMode || isFPSGraphMode) {
            auto* framePadding = new tsl::elm::ListItem("Отступ рамки");
        ...
        if (isMicroMode) {
            ...
            auto* textAlign = new tsl::elm::ListItem("Выравнивание текста");
            ...
            auto* layerPos = new tsl::elm::ListItem("Вертикальная позиция");
            ...
            auto* layerPos = new tsl::elm::ListItem("Горизонтальная позиция");
        ...
        tsl::elm::OverlayFrame* rootFrame = new tsl::elm::OverlayFrame("Ryazha-Status-Monitor", modeName);
        rootFrame->setContent(list);
        return rootFrame;
    }
...
private:
    ...
    std::string cycleTextAlign() {
        if (isMicroMode) {
            ...
            std::string next;
            if (current == "Слева") next = "По центру";
            else if (current == "По центру") next = "Справа";
            else if (current == "Справа") next = "Слева";
            else next = "По центру";
    ...
    std::string cycleLayerPosRight() {
        ...
        const std::string value = (next == "Справа") ? "right" : (next == "По центру" ? "center" : "left");
    ...
    std::string cycleLayerPosBottom() {
        ...
        if (isMicroMode) {
            ...
            if (current == "Сверху") next = "Снизу";
            else next = "Сверху";
        } else {
            // Other modes: Top -> Center -> Bottom -> Top
            if (current == "Сверху") next = "По центру";
            else if (current == "По центру") next = "Снизу";
            else next = "Сверху";
        }
        
        const std::string value = (next == "Снизу") ? "bottom" : (next == "По центру" ? "center" : "top");
